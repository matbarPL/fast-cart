---
title: "Rules that can be found inside shopping cart. How to quickly measure transactions relationships?"
...
<br/><br/>
As documentation claims rule that contain empty bracket means that no matter what other items are involved the item
